...
$output_path = 'C:\Ansible'

$testUserAccountName = 'sysnt'
$testUserAccountPassword = (ConvertTo-SecureString -String '7bbF*U!Mvx9jmZ934y5BajnV9)@wicnE' -AsPlainText -Force)
...
$ansibleCert = Get-ChildItem -Path 'Cert:\LocalMachine\Root' | ? {$_.Subject -eq 'CN=sysnt'}
